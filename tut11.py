...
#Heading
Label(root,text="Welcome to GoSu Travels" ,font= "comicsansms 13 bold",pady =15).grid(row=0,column=3)
...
paymentmode = Label(root,text="Payement Mode")
...
# In tkinter variable class there is a get function and set function.
namevalue = StringVar()
...
Button(text =" Submit to GoSu Travels",command=getvals).grid(row=7,column=3)
